...
class Semeval_NLI_M_Processor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        train_data = pd.read_csv(os.path.join(data_dir, "bt/bt_train_NLI_16_8.csv"), header=None,
                                 sep="\t").values
    ...
    def get_test_examples(self, data_dir):
        """See base class."""
        test_data = pd.read_csv(os.path.join(data_dir, "test_NLI_16.csv"), header=None, sep="\t").values
